...
namespace OpenCvSharpYolo3
{
    ...
    class Program
    {
        ...
        //file location
        private const string Location = "C:\\Users\\liugang\\source\\repos\\YOLO3-With-OpenCvSharp4-master\\OpenCvSharpYolo3\\Content\\";
        ...
        {
            #region parameter
            var image = Path.Combine(Location, "horses.jpg");
